...
const Attendance: React.FC = () => {
  ...
  useEffect(() => {
    const fetchAttendanceSummary = async () => {
      if (!user?.schoolId || activeTab !== 'reports') return;
      setSummaryLoading(true);
      try {
        const summary = await teacherAttendanceService.getTeacherAttendanceSummary(
          user.schoolId,
          fromDate || undefined,
          toDate || undefined
        );
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="flex items-center justify-center">
              <div className="relative w-48 h-48">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-2xl font-bold text-gray-900 dark:text-white">{attendanceSummary?.totalRecords || 0}</div>
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <span className="text-sm text-gray-700 dark:text-gray-300">Present: {attendanceSummary?.presentCount || 0} ({attendanceSummary?.presentPercentage || '0%'})</span>
              </div>
              <div className="flex items-center">
                <div className="w-4 h-4 bg-red-500 rounded-full mr-3"></div>
                <span className="text-sm text-gray-700 dark:text-gray-300">Absent: {attendanceSummary?.absentCount || 0} ({attendanceSummary?.absentPercentage || '0%'})</span>
              </div>
